...
namespace MobileMapViewer.Shared.Services
{
        ...
        IAuthService
    {
        ...
        public OAuthService(string serverUrl, string appClientId, string clientSecret, string oathClientRedirect)
        {
#if __ANDROID__
            //_oathClientRedirect = @"urn:ietf:wg:oauth:2.0:oob";
            _oathClientRedirect = @"protection-mobile://auth";
#else
